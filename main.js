...
const myKey = ec.keyFromPrivate('e4e87b840634d178a3e60183cde01a47f8eb848ff47a7982b941db855a5cdf17');
...
console.log();
console.log(`Balance of user is ${pinkycoin.getBalanceOfAddress(myWalletAddress)}`);
